...
class WC_Twilio_SMS_Loader {
	...
	public const PLUGIN_NAME = 'WooCommerce Twilio SMS Notifications';

	/** @var WC_Twilio_SMS_Loader|null single instance of this class */
	private static ?WC_Twilio_SMS_Loader $instance = null;
	...
	public function __clone() {
		...
		_doing_it_wrong( __FUNCTION__, sprintf( 'You cannot clone instances of %s.', esc_html( get_class( $this ) ) ), '1.12.1' );
	}
	...
	public function __wakeup() {
		...
		_doing_it_wrong( __FUNCTION__, sprintf( 'You cannot unserialize instances of %s.', esc_html( get_class( $this ) ) ), '1.12.1' );
	}
	 ...
	 */
	public static function instance() : WC_Twilio_SMS_Loader
	{
