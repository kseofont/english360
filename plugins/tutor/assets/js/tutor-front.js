(()=>{var t={37392:function(){// this function will load after document content load
...
t("textarea").val("")},error:function t(t){r.removeClass("is-loading").prop("disabled",false)}})})})},43831:function(){window.jQuery(document).ready(t=>{/**
     * Share Link enable
     *
     * @since v.1.0.4
     */if(t.fn.ShareLink){var e=t(".tutor-social-share-wrap");if(e.length){var r=JSON.parse(e.attr("data-social-share-config"));e.find(".tutor_share").ShareLink({title:r.title,text:r.text,image:r.image,class_prefix:"s_",width:640,height:480})}}})},37691:function(){window.jQuery(document).ready(t=>{var{__}=window.wp.i18n;/**
...
var a=new Blob([o],{type:"text/csv;charset=utf-8"});var n=URL.createObjectURL(a);var i=document.createElement("a");i.setAttribute("href",n);i.setAttribute("download",e);i.style.visibility="hidden";document.body.appendChild(i);i.click();document.body.removeChild(i)}})},52966:function(){/**
...
var t=document.getElementById("tutor-course-save-draft");if(t){t.onclick=e=>{e.preventDefault();t.setAttribute("disabled","disabled");t.classList.add("is-loading");document.getElementById("tutor-frontend-course-builder").submit()}}/**
	 ...
	 *
	 * @since 2.2.4
	 */var e=jQuery(".tutor-table-responsive .tutor-table .tutor-dropdown");if(e.length){var r=jQuery(".tutor-table-responsive .tutor-table").height();jQuery(".tutor-table-responsive").css("min-height",r+110)}})},47426:function(){document.addEventListener("DOMContentLoaded",()=>{// Toggle menu in mobile view
var t=window.jQuery;t(".tutor-dashboard .tutor-dashboard-menu-toggler").click(function(){var e=t(".tutor-dashboard-left-menu");e.closest(".tutor-dashboard").toggleClass("is-sidebar-expanded");if(e.css("display")!=="none"){e.get(0).scrollIntoView({block:"start"})}})})},43963:function(t,e,r){var{get_response_message:o}=r(12235);window.jQuery(document).ready(t=>{var{__}=wp.i18n;t('.tutor-settings-pass-field [name="confirm_new_password"]').on("input",function(){var e=t('[name="new_password"]');var r=(e.val()||"").trim();var o=r&&t(this).val()===r;t(this).parent().find(".tutor-validation-icon")[o?"show":"hide"]()});t(".tutor-profile-password-reset").click(function(e){e.preventDefault();var r=t(this);var a=r.closest("form");var n=a.serializeObject();n.action="tutor_profile_password_reset";t.ajax({url:_tutorobject.ajaxurl,type:"POST",data:n,beforeSend:()=>{r.addClass("is-loading")},success:t=>{var{success:e}=t;if(e){window.tutor_toast(__("Success","tutor"),o(t),"success");window.location.reload()}else{window.tutor_toast(__("Error","tutor"),o(t),"error")}},complete:()=>{r.removeClass("is-loading")}})})})},99255:function(t,e,r){var{get_response_message:o}=r(12235);var a=t=>{var e=new RegExp("^(https?:\\/\\/)?"+// protocol
...
(()=>{r.ruid="bundler=rspack@1.6.4"})();var o={};// This entry needs to be wrapped in an IIFE because it needs to be in strict mode.
...
var i=r(37392);// CONCATENATED MODULE: ./assets/react/helper/utils.js
...
var c=r(99210);// CONCATENATED MODULE: ./assets/react/helper/tutor-formdata.js
/**
...
var _=r(24898);// EXTERNAL MODULE: ./assets/react/front/course/_social-share.js
var h=r(43831);// CONCATENATED MODULE: ./assets/react/front/course/_spotlight.js
...
var g=r(9008);// EXTERNAL MODULE: ./assets/react/front/course/_spotlight-quiz-timing.js
var b=r(37691);// EXTERNAL MODULE: ./assets/react/front/course/_wishlist.js
var y=r(39061);// EXTERNAL MODULE: ./assets/react/front/course/_woocommerce.js
var w=r(99964);// CONCATENATED MODULE: ./assets/react/front/course/index.js
...
var q=r(47426);// EXTERNAL MODULE: ./assets/react/front/dashboard/withdrawal.js
var k=r(2935);// EXTERNAL MODULE: ./assets/react/front/dashboard/settings/profile.js
var S=r(99255);// EXTERNAL MODULE: ./assets/react/front/dashboard/settings/passowrd-reset.js
var x=r(43963);// CONCATENATED MODULE: ./assets/react/front/dashboard/settings/billing.js
...
var L=r(52966);// CONCATENATED MODULE: ./assets/react/front/dashboard.js
// EXTERNAL MODULE: ./assets/react/front/dashboard/export-csv.js
var j=r(25071);// CONCATENATED MODULE: ./assets/react/front/pages/billing.js
...
var E=r(69951);// EXTERNAL MODULE: ./assets/react/front/pages/instructor-list-filter.js
var C=r(83351);// CONCATENATED MODULE: ./assets/react/front/tutor-front.js
/**
