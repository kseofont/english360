...
class Ellen_Banner_Five extends Widget_Base {

	public function get_name() {
        return 'Ellen_Banner_Five';
    }

	public function get_title() {
        return esc_html__( 'Banner Five', 'ellen-toolkit' );
    }
	...
	protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            $this->add_control( 'title', [
                ...
                'default'     => esc_html__( 'Learn cooking and teach cooking', 'ellen-toolkit' ),
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control( 'banner_padding', [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors'  => [
                    '{{WRAPPER}} .kitchen-coach-banner-area' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ] );
            ...
            $this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .kitchen-coach-banner-area' => 'background-color: {{VALUE}}',
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .kitchen-coach-banner-content .title' => 'color: {{VALUE}}',
					],
				]
			);
			...
			$this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .kitchen-coach-banner-content .title',
                ]
            );
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .kitchen-coach-banner-content .banner-btn-list li .default-btn, {{WRAPPER}} .kitchen-coach-banner-content .banner-btn-list li .popup-video',
                ]
            );
            ...
            $this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .kitchen-coach-banner-content .banner-btn-list li .default-btn' => 'color: {{VALUE}}',
					],
				]
			);
            ...
            $this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .kitchen-coach-banner-content .banner-btn-list li .default-btn' => 'background-color: {{VALUE}}',
						'{{WRAPPER}} .kitchen-coach-banner-content .banner-btn-list li .default-btn' => 'border-color: {{VALUE}}',
					],
				]
			);
            ...
            $this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .kitchen-coach-banner-content .banner-btn-list li .default-btn:hover' => 'background-color: {{VALUE}}',
					],
				]
			);
            ...
            $this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .kitchen-coach-banner-content .banner-btn-list li .default-btn:hover' => 'color: {{VALUE}}',
					],
				]
			);
            ...
            $this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .kitchen-coach-banner-content .banner-btn-list li .popup-video' => 'color: {{VALUE}}',
					],
				]
			);
            ...
            $this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .kitchen-coach-banner-content .banner-btn-list li .popup-video' => 'background-color: {{VALUE}}',
					],
				]
			);
            ...
            $this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .kitchen-coach-banner-content .banner-btn-list li .popup-video:hover' => 'background-color: {{VALUE}}',
					],
				]
			);
            ...
            $this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .kitchen-coach-banner-content .banner-btn-list li .popup-video:hover' => 'color: {{VALUE}}',
					],
				]
			);
...
Plugin::instance()->widgets_manager->register( new Ellen_Banner_Five );