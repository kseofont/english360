...
class Ellen_Banner_Nine extends Widget_Base {

	public function get_name() {
        return 'Ellen_Banner_Nine';
    }

	public function get_title() {
        return esc_html__( 'Banner Nine', 'ellen-toolkit' );
    }
	...
	protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            $this->add_control( 'title', [
                ...
                'default'     => esc_html__( 'Unlock Your Business Potential with Expert Coaching', 'ellen-toolkit' ),
			...
			$this->add_control(
				...
				[
					...
					'default' 	=> esc_html__('Empowering Entrepreneurs to Achieve Success and Growth', 'ellen-toolkit'),
                    'label_block' => true,
				]
			);
            ...
            $this->add_control(
				...
				[
					...
					'type' 		=> Controls_Manager::TEXT,
					'default' 	=> esc_html__('Book Your Free Consultation', 'ellen-toolkit'),
				]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                'shape2',
                [
                    'label'		=> esc_html__('Shape Image Nine', 'ellen-toolkit'),
                    'type'		=> Controls_Manager:: MEDIA,
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control( 'banner_padding', [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors'  => [
                    '{{WRAPPER}} .business-coach-banner-area' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ] );
            ...
            $this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .business-coach-banner-area' => 'background-color: {{VALUE}}',
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .business-coach-banner-content .title' => 'color: {{VALUE}}',
					],
				]
			);
			...
			$this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .business-coach-banner-content .title',
                ]
            );
			...
			$this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .business-coach-banner-content p' => 'color: {{VALUE}}',
					],
				]
			);
			...
			$this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .business-coach-banner-content p',
                ]
            );
            ...
            $this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .business-coach-banner-content .banner-btn .default-btn' => 'background-color: {{VALUE}}',
					],
				]
			);
            ...
            $this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .business-coach-banner-content .banner-btn .default-btn:hover' => 'background-color: {{VALUE}}',
					],
				]
			);
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .business-coach-banner-content .banner-btn .default-btn',
                ]
            );
	...
	protected function render() {
        ...
        ?>
        <div class="business-coach-banner-area">
            <div class="container">
                <div class="row justify-content-center align-items-center">
                    <div class="col-lg-7 col-md-12">
                        <div class="business-coach-banner-content">
                    ...
                    <div class="col-lg-5 col-md-12">
                        <?php if( $settings['image1']['url'] != '' ): ?>
                            <div class="business-coach-banner-image">
            ...
            <?php if( $settings['shape1']['url'] != '' ): ?>
                <div class="business-coach-banner-shape1" data-speed="0.10" data-revert="true">
                    <img src="<?php echo esc_url( $settings['shape1']['url'] ); ?>" alt="<?php echo esc_attr( $settings['title'] ); ?>">
                </div>
            <?php endif; ?>

            <?php if( $settings['shape2']['url'] != '' ): ?>
                <div class="business-coach-banner-shape2" data-speed="0.10" data-revert="true">
...
Plugin::instance()->widgets_manager->register( new Ellen_Banner_Nine );