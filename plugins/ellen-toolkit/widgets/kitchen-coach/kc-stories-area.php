<?php
/**
 * Kitchen Coach Stories Area Widget
 */
...
class Ellen_KC_Stories_Area extends Widget_Base {

	public function get_name() {
        return 'Ellen_KC_Stories_Area';
    }
	...
	protected function register_controls() {
        ...
        $this->start_controls_section(
			'Ellen_KC_Stories_Area',
			[
				'label' => esc_html__( 'Stories Controls', 'ellen-toolkit' ),
            ...
            $this->add_control(
				...
				[
					...
					'default' 	=> esc_html__('Marry the person who gives you a similar inclination you get when you see nourishment coming at an eatery.', 'ellen-toolkit'),
                    'label_block' => true,
				]
			);
            $this->add_control(
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control( 'about_padding', [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors'  => [
                    '{{WRAPPER}} .kc-stories-area, {{WRAPPER}} .vc-overview-area' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ] );
            ...
            $this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .kc-stories-area, {{WRAPPER}} .vc-overview-area' => 'background-color: {{VALUE}}',
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .kc-stories-content .title, {{WRAPPER}} .vc-overview-content .title' => 'color: {{VALUE}}',
					],
				]
			);
			...
			$this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .kc-stories-content .title, {{WRAPPER}} .vc-overview-content .title',
                ]
            );
			...
			$this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .kc-stories-content p, {{WRAPPER}} .vc-overview-content p' => 'color: {{VALUE}}',
					],
				]
			);
			...
			$this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .kc-stories-content p, {{WRAPPER}} .vc-overview-content p',
                ]
            );
            ...
            $this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .kc-stories-content .box p, {{WRAPPER}} .vc-overview-content .box p' => 'color: {{VALUE}}',
					],
				]
			);
			...
			$this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .kc-stories-content .box p, {{WRAPPER}} .vc-overview-content .box p',
                ]
            );
	...
	protected function render() {
        ...
        if($settings['style'] == '2'): ?>
            <div class="vc-overview-area pb-100" style="background-image:url(<?php echo esc_url( $settings['shape1']['url'] ); ?>);">
                <div class="container">
...
Plugin::instance()->widgets_manager->register( new Ellen_KC_Stories_Area );