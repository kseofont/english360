...
class Sc_Navbar extends Widget_Base {

    public function get_name() {
        return 'ellen-navbar-sc';
    }

    public function get_title() {
        return __( 'Navbar School', 'ellen-toolkit' );
    }
    ...
    public function get_keywords() {
        return [ 'School College Menu', 'Navigation' ];
    }
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .school-college-navbar' => 'background-color: {{VALUE}} !important',
					],
				]
            );
            ...
            $this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .school-college-navbar.is-sticky' => 'background-color: {{VALUE}} !important',
					],
				]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{SELECTOR}} .school-college-navbar.is-sticky' => 'box-shadow: {{HORIZONTAL}}px {{VERTICAL}}px {{BLUR}}px {{SPREAD}}px {{COLOR}};',
                    ],
                ]
            );
            ...
            $this->add_control(
                'sec_padding', [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .school-college-navbar' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                    'default' => [
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .school-college-navbar .ellen-responsive-nav .mean-container a.meanmenu-reveal' => 'background-color: {{VALUE}} !important',
					],
				]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_group_control(
                Group_Control_Typography::get_type(), [
                    ...
                    'selector' => '{{WRAPPER}} .school-college-navbar .ellen-nav .navbar .navbar-nav .nav-item .nav-link',
                ]
            );
            $this->add_control(
				'menu_item_color',
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .school-college-navbar .ellen-nav .navbar .others-option .option-item .search-box-popup i' => 'color: {{VALUE}}',
                    ],
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .school-college-navbar .ellen-nav .navbar .others-option .option-item .search-box-popup i:hover' => 'color: {{VALUE}}',
                    ],
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .school-college-navbar .ellen-nav .navbar .others-option .option-item .search-box-popup i' => 'background-color: {{VALUE}}',
                    ],
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .school-college-navbar .ellen-nav .navbar .others-option .option-item .search-box-popup i:hover' => 'background-color: {{VALUE}}',
                    ],
                ]
            );
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .school-college-navbar .ellen-nav .navbar .others-option .option-item .search-box-popup i',
                ]
            );
    ...
    protected function render() {
        ...
        <!-- Start Navbar Area -->
        <div class="navbar-area school-college-navbar school-college-home <?php if ( is_user_logged_in() ) { echo esc_attr( $hide_adminbar ); } ?>  <?php if( $settings['hide_is_sticky'] == 'yes' ): ?> no-sticky <?php endif; ?>">
...
Plugin::instance()->widgets_manager->register( new Sc_Navbar );