...
class Sc_Admissions extends Widget_Base {

	public function get_name() {
        return 'Admissions_Sc';
    }

	public function get_title() {
        return esc_html__( 'School & College Admissions', 'ellen-toolkit' );
    }
	...
	protected function register_controls() {
        ...
        $this->start_controls_section(
			'Admissions_Area',
			[
				'label' => esc_html__( 'Admissions Controls', 'ellen-toolkit' ),
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default'     => __('MEET ADMISSIONS', 'ellen-toolkit'),
                    'label_block' => true,
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type'        => Controls_Manager::TEXTAREA,
                    'default'     => __('Learn More About Life at St. Ellen School', 'ellen-toolkit'),
                    'label_block' => true,
                ]
            );
            ...
            $this->add_control(
				...
				[
					...
					'default' 	=> esc_html__('Contact Admissions', 'ellen-toolkit'),
				]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .sc-admissions-content .sub::before' => 'color: {{VALUE}}',
                    ],
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .sc-admissions-content .sub' => 'color: {{VALUE}}',
                    ],
                ]
            );
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .sc-admissions-content .sub',
                ]
            );
			...
			$this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .sc-admissions-content .title-tags' => 'color: {{VALUE}}',
					],
				]
			);
			...
			$this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .sc-admissions-content .title-tags',
                ]
            );
	...
	protected function render() {
        ...
        <!-- Start SC Admissions Area -->
        <div class="sc-admissions-area school-college-home ptb-100">
            <div class="container">
                <div class="row justify-content-center align-items-center">
                    <div class="col-lg-7 col-md-12">
                        <div class="sc-admissions-content">
...
Plugin::instance()->widgets_manager->register( new Sc_Admissions );