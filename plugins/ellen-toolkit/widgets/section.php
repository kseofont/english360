...
class Ellen_Section extends Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Section', 'ellen-toolkit' );
    }
	...
	protected function register_controls() {
        ...
        $this->start_controls_section(
			'Ellen_Section',
			[
				'label' => esc_html__( 'Ellen Section', 'ellen-toolkit' ),
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => esc_html__('Education for everyone', 'ellen-toolkit'),
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .section-title .default-btn' => 'border-color: {{VALUE}}',
					],
				]
			);
            ...
            $this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .section-title .default-btn:hover' => 'background-color: {{VALUE}}',
					],
				]
			);
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .section-title .default-btn',
                ]
            );
...
Plugin::instance()->widgets_manager->register( new Ellen_Section );