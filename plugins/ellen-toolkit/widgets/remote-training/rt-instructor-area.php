...
class Ellen_Instructor_Area extends Widget_Base {

	public function get_name() {
        return 'Ellen_Instructor_Area';
    }

	public function get_title() {
        return esc_html__( 'Instructor Area', 'ellen-toolkit' );
    }
	...
	protected function register_controls() {
        ...
        $this->start_controls_section(
			'Ellen_Instructor_Area',
			[
				'label' => esc_html__( 'Instructor Area Controls', 'ellen-toolkit' ),
            ...
            $this->add_control( 'title', [
                ...
                'default'     => esc_html__( 'Become an Instructor And Join with us', 'ellen-toolkit' ),
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control( 'section_padding', [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors'  => [
                    '{{WRAPPER}} .rt-instructor-area.ptb-100' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ] );
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .rt-instructor-content .title' => 'color: {{VALUE}}',
					],
				]
			);
			...
			$this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .rt-instructor-content .title',
                ]
            );
			...
			$this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .rt-instructor-content p' => 'color: {{VALUE}}',
					],
				]
			);
			...
			$this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .rt-instructor-content p',
                ]
            );
	...
	protected function render() {
        ...
        <div class="rt-instructor-area ptb-100">
            <div class="container">
            ...
            <div class="rt-instructor-shape-1">
                <?php if( $settings['bg']['url'] != '' ): ?>
                    <?php echo wp_get_attachment_image( $settings['bg']['id'], 'full' ); ?>
                <?php endif; ?>
            </div>
...
Plugin::instance()->widgets_manager->register( new Ellen_Instructor_Area );