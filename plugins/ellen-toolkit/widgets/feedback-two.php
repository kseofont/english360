...
class Ellen_Feedback_Two extends Widget_Base {
	...
	public function get_title() {
        return __( 'Feedback Two', 'ellen-toolkit' );
    }
    ...
    $this->start_controls_section(
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .bc-testimonials-card p' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .bc-testimonials-card p',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .bc-testimonials-card .info .title h3' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .bc-testimonials-card .info .title h3',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .bc-testimonials-card .info .title span' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .bc-testimonials-card .info .title span',
            ]
        );
    $this->end_controls_section();
    }
	...
	protected function render() {
        ...
        <div class="container">
            <div class="bc-testimonials-slides owl-carousel owl-theme">
                <?php foreach ($items as $key => $value): ?>
                    <div class="bc-testimonials-card">
...
Plugin::instance()->widgets_manager->register( new Ellen_Feedback_Two );