...
class Ellen_Tutor_Categories extends Widget_Base {

	public function get_name() {
        return 'Ellen_Tutor_Categories';
    }

	public function get_title() {
        return __( 'Tutor Categories', 'ellen-toolkit' );
    }
	...
	protected function register_controls() {
        ...
        $this->start_controls_section(
			...
			$this->add_control(
                'shape_image',
                [
                    'label' => esc_html__( 'Shape Image(Style One)', 'ellen-toolkit' ),
                    'type' => Controls_Manager::MEDIA,
                ]
            );
                ...
                <div class="row justify-content-center">
                    <?php foreach( $settings['items'] as $item ):
                        ...
                        if (!empty($item['cat_name'])) {
                            $category = get_term_by('slug', $item['cat_name'], 'course-category');
                            if ($category && !is_wp_error($category)) {
                                $cat_link = get_term_link($category);
                                $cat_name = $category->name;
                            } else {
                                $cat_name = $item['cat_name']; // Fallback to the slug if term not found
                            }
                        }
                        ?>
...
Plugin::instance()->widgets_manager->register( new Ellen_Tutor_Categories );