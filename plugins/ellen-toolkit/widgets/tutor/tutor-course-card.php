...
class Ellen_Tutor_Courses_Card extends Widget_Base {

	public function get_name() {
        return 'TutorCoursesCard';
    }

	public function get_title() {
        return esc_html__( 'Tutor Courses Card', 'ellen-toolkit' );
    }
	...
	protected function register_controls() {
        ...
        $this->start_controls_section(
			'course_section',
			[
				'label' => esc_html__( 'Tutor Course Card', 'ellen-toolkit' ),
...
Plugin::instance()->widgets_manager->register( new Ellen_Tutor_Courses_Card );