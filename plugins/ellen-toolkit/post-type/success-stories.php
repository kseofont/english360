...
class Success_Stories {
     ...
     */
    private $type               = 'success-stories';
    private $slug               = 'success-stories';
    ...
    public function register() {
        $labels = array(
            ...
            'add_new_item'          => 'Add New Story '   . $this->singular_name,
            'edit_item'             => 'Edit Story '      . $this->singular_name,
        ...
        $args = array(
            ...
            'yarpp_support'         => true,
            'menu_icon'             => $this->icon,
            'taxonomies'            => array( 'success-stories-cat' ),
        );
